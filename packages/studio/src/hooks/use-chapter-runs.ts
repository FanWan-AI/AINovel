...
export type ChapterRunActionType = "spot-fix" | "polish" | "rework" | "rewrite" | "anti-detect" | "resync" | "chapter-redesign" | "blueprint-targeted-revise" | "length-normalize" | "pipeline-snapshot";
