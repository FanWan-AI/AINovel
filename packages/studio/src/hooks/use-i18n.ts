...
export const strings = {
  ...
  "assistant.planTitle": { zh: "任务计划", en: "Task Plan" },
  "assistant.planStatus": { zh: "当前状态", en: "Status" },
  "assistant.planStatusDraft": { zh: "草拟中", en: "Draft" },
  "assistant.planStatusAwaitingConfirm": { zh: "待确认", en: "Awaiting Confirmation" },
  "assistant.planStatusRunning": { zh: "执行中", en: "Running" },
  "assistant.planStatusSucceeded": { zh: "已成功", en: "Succeeded" },
  "assistant.planStatusFailed": { zh: "已失败", en: "Failed" },
  "assistant.planStatusCancelled": { zh: "已取消", en: "Cancelled" },
  "assistant.planPrompt": { zh: "计划内容", en: "Plan Prompt" },
  "assistant.actionWriteNext": { zh: "写下一章", en: "Write Next Chapter" },
  "assistant.actionAudit": { zh: "审计章节", en: "Audit Chapter" },
  "assistant.actionTemplate": { zh: "模板任务", en: "Template Task" },
  ...
  "assistant.templateTitle": { zh: "新手模板", en: "Starter Templates" },
  "assistant.templateStructure": { zh: "结构生成（3卷30章）", en: "Generate Structure (3 Volumes / 30 Chapters)" },
  "assistant.templateWriteNextAudit": { zh: "写下一章并自审", en: "Write Next Chapter + Self Audit" },
  "assistant.templateRecentAuditRepair": { zh: "最近三章审计修复", en: "Audit & Repair Last 3 Chapters" },
  ...
  "book.audit": { zh: "审核", en: "Audit" },
  "book.resync": { zh: "同步", en: "Sync" },
  ...
  // 四大动作 — 一级按钮
  "book.refine": { zh: "微调", en: "Refine" },
  "book.rewriteInPlace": { zh: "改写", en: "Rewrite In-Place" },
  "book.regenerate": { zh: "重生成", en: "Regenerate" },
  "book.versions": { zh: "版本", en: "Versions" },

  // 四大动作 — hover 文案
  "book.refineTooltip": { zh: "在不改变剧情的前提下，优化这一章的文字质量。", en: "Optimize text quality without changing the plot." },
  "book.rewriteInPlaceTooltip": { zh: "保留这一章的位置与基本目标，但允许调整剧情组织、冲突和节奏。", en: "Keep chapter position but allow adjusting plot, conflicts and pacing." },
  "book.regenerateTooltip": { zh: "放弃当前版本，从上一章重新生成这一章。改动最大，请谨慎使用。", en: "Discard current version and regenerate from previous chapter. Use with caution." },
  "book.versionsTooltip": { zh: "管理这一章的历史修改记录，支持对比、恢复和分支保存。", en: "Manage chapter revision history with compare, restore and branch." },

  // 微调子项
  "book.fixIssues": { zh: "修正问题", en: "Fix Issues" },
  "book.polishExpression": { zh: "润色表达", en: "Polish Expression" },
  "book.reduceAiTrace": { zh: "降低AI痕迹", en: "Reduce AI Traces" },
  "book.fixIssuesTooltip": { zh: "针对明显问题做小范围修正，不改剧情走向。", en: "Fix obvious issues with minimal changes, preserving plot direction." },
  "book.polishExpressionTooltip": { zh: "优化语言、节奏和段落呼吸，让这一章更顺更有表现力。", en: "Improve language, pacing and paragraph flow." },
  "book.reduceAiTraceTooltip": { zh: "保持剧情不变，减少模板化表达，让文字更自然。", en: "Keep plot intact, reduce formulaic expressions for more natural text." },

  // 改写子项
  "book.lightRewrite": { zh: "轻度改写", en: "Light Rewrite" },
  "book.deepRewrite": { zh: "深度改写", en: "Deep Rewrite" },
  "book.targetedRewrite": { zh: "定向改写", en: "Targeted Rewrite" },
  "book.lightRewriteTooltip": { zh: "保留主要内容，优化场景推进、冲突组织和章节节奏。", en: "Keep main content, optimize scene progression, conflicts and pacing." },
  "book.deepRewriteTooltip": { zh: "对这一章做更大幅度重构，可改变场景安排、互动方式和结尾效果。", en: "Major restructuring — change scenes, interactions and ending." },
  "book.targetedRewriteTooltip": { zh: "按你的具体要求改这一章，例如改冲突、改人物互动、改结尾钩子。", en: "Rewrite chapter per your specific instructions." },

  // 重生成子项
  "book.regenerateChapter": { zh: "重新生成本章", en: "Regenerate Chapter" },
  "book.regenerateWithBrief": { zh: "带要求重生成", en: "Regenerate with Brief" },
  "book.regenerateChapterTooltip": { zh: "当前章会被替换，系统将从上一章重新续写本章。", en: "Current chapter will be replaced, regenerated from the previous chapter." },
  "book.regenerateWithBriefTooltip": { zh: "在重新生成的同时加入你的额外要求，例如人物出场、节奏或结尾效果。", en: "Regenerate with your extra requirements like character appearance, pacing or ending." },

  // 版本子项
  "book.viewVersions": { zh: "查看版本", en: "View Versions" },
  "book.compareDiff": { zh: "对比差异", en: "Compare Diff" },
  "book.restoreVersion": { zh: "恢复版本", en: "Restore Version" },
  ...
  "chapterAction.titleRewrite": { zh: "重新生成本章", en: "Regenerate Chapter" },
  "chapterAction.titleResync": { zh: "同步章节状态", en: "Sync Chapter State" },
  "chapterAction.titleRewriteInPlace": { zh: "改写本章", en: "Rewrite Chapter In-Place" },
  ...
  "chapterAction.descRewrite": { zh: "当前章节内容将被替换。系统将回滚到上一章并重新续写本章。", en: "Current chapter will be replaced. The system will roll back and regenerate from the previous chapter." },
  "chapterAction.descRewriteInPlace": { zh: "保留章节位置与基本目标，对这一章的剧情组织、冲突和节奏做中到大幅度调整。", en: "Keep chapter position and goals, adjust plot organization, conflicts and pacing significantly." },
  ...
  "chapterAction.briefLabelRequired": { zh: "你的改写要求", en: "Your Rewrite Requirements" },
  ...
  "chapterAction.placeholderRewrite": { zh: "例：从上一章重新续写，让这一章更有冲突，结尾更强。", en: "e.g. regenerate with stronger conflicts and a more powerful ending." },
  "chapterAction.placeholderRewriteInPlace": { zh: "例：把这一章改成林薇和万凡在饭店对谈，结尾增加反转钩子。", en: "e.g. change this chapter to a restaurant scene with a twist ending hook." },
  "chapterAction.placeholderResync": { zh: "例：以最新人物关系为准，优先同步伏笔状态。", en: "e.g. prioritize latest character relations and pending hooks." },
  "chapterAction.submitRevise": { zh: "开始微调", en: "Start Refinement" },
  "chapterAction.submitRewrite": { zh: "确认重生成", en: "Confirm Regeneration" },
  "chapterAction.submitRewriteInPlace": { zh: "开始改写", en: "Start Rewrite" },
  "chapterAction.submitResync": { zh: "开始同步", en: "Start Sync" },
  "chapterAction.confirmRegenTitle": { zh: "确认重新生成本章？", en: "Confirm chapter regeneration?" },
  "chapterAction.confirmRegenDesc": { zh: "当前章节内容将被替换。你仍可以在版本记录中找回旧稿。", en: "Current chapter will be replaced. You can still find the old draft in version history." },
  ...
  "chapterAction.noticeRewriteStarted": { zh: "已提交章节重生成任务", en: "Chapter regeneration has started" },
  "chapterAction.noticeRewriteDone": { zh: "章节重生成完成", en: "Chapter regeneration completed" },
