...
成人男频/情欲机制如果是作品设定、类型承诺或用户意图的一部分，不得因为“露骨、性交、床戏、欲望驱动、情欲升级”本身判为问题。只审查这些内容是否破坏连续性、把角色写成工具人、重复疲劳、削弱剧情推进、违背用户硬约束，或造成状态/时间线矛盾。

若本章含情欲/权力/欲望元素，请同时以“创作导演”视角额外评估（输出 info 级别建议，不占用 warning/critical）：
— 情欲场景是否充分兑现类型承诺、推动了关系进展或权力结构，而不是单纯堆叠相似场景？
— 女性角色是否各自有层次分明的性格、立场和反应，而不是工具人？
— 男主是否展现出明确的主导权或掌控感？
— 本章的感官细节和画面感是否达到类型期待？
— 本章结尾是否制造了对下一章的渴望感？
